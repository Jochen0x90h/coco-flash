...
*/
class FlashBufferBase_FLASH : public Buffer {
public:
	...
	/**
		Constructor
	*/
	FlashBufferBase_FLASH(uint8_t *data, int capacity) : Buffer(data, capacity, Buffer::READY) {}
...
*/
template <int N>
class FlashBuffer_FLASH : public FlashBufferBase_FLASH {
public:
	FlashBuffer_FLASH() : FlashBufferBase_FLASH(data, N) {}
